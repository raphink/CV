...
\cvline{Gestion de configuration}{Puppet\contributor, MCollective\contributor, Augeas\developer}

\subsection{D\'eveloppement}
\cvcomputer{Langages}{C, Perl, Python, Shell/Bash, Ruby, GNU Make, Ada, Lua}{Web}{HTML/XHTML, CSS, JavaScript, Ajax, Jquery, PHP, Web s\'emantique}
...
\cvcomputer{Gestion de sources}{RCS/CVS, SVN, Bazaar, Git, Mercurial}{Outils}{Autotools, Cmake, Doxygen, NaturalDocs, Trac, Gforge, Launchpad, GitHub}

\subsection{Administration syst\`eme et r\'eseau}
\cvcomputer{Web}{Apache, Lighttpd, Nginx, Varnish, Bind, Squid, Dansguardian, VsFTPd}{Monitoring}{BB4/Hobbit, Nagios, Munin, Cacti, Simple Event Correlator (Sec)}
...
\cvcomputer{Syst\`emes d'exploitation}{GNU/Linux (Debian\contributor, Ubuntu\developer, RedHat), MacOS X, Windows, *BSD}{Bases de donn\'ees}{MySQL, PostgreSQL, SQLite, BerkeleyDB}
...
\begin{itemize}
 \item Automatisation d'infrastructures avec Puppet;
 \item Mise en place de solutions cloud redondantes;
 \item Conférences devops;
 \item Formations techniques (Puppet, Augeas);
 \item Consultance technique avant-vente.
\end{itemize}}
