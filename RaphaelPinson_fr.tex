...
\cvcomputer{Gestion de configuration}{Puppet\contributor, MCollective\contributor, Augeas\developer}
           {OS Debian}{Debian\contributor, Ubuntu\developer}

\subsection{D\'eveloppement}
\cvcomputer{Langages}{C, Perl, Python, Shell/Bash, Ruby, GNU Make, Ada, Lua}{Web}{HTML/XHTML, CSS, JavaScript, Ajax, Jquery, Bootstrap, PHP, Web s\'emantique}
...
\cvcomputer{Virtualisation}{Xen, VMWare, OpenVZ, LXC, Openstack, Amazon Web Services}{S\'ecurit\'e}{SSL, PGP/GnuPG, OpenSSH}
...
\begin{itemize}
  \item Ingénieur systèmes:
    \begin{itemize}
      \item Gestion d'une flotte de 500+ serveurs gérés par Puppet (y compris des esrveurs de l'EPFL et de Swisstopo);
