...
\cvcomputer{Gestion de configuration}{Puppet\contributor, Docker, Augeas\developer}
           {OS Debian}{Debian\contributor, Ubuntu\developer}

\subsection{D\'eveloppement}
\cvcomputer{Langages}{C, Perl, Python, Shell/Bash, Ruby, Go, GNU Make, Ada, Lua}{Web}{HTML/XHTML, CSS, JavaScript, Ajax, Jquery, Bootstrap, PHP, Web s\'emantique}
...
\cvcomputer{Gestion de sources}{RCS/CVS, SVN, Bazaar, Git, Mercurial}{Outils}{Autotools, Cmake, Trac, Gforge, Launchpad, GitHub}
...
\cvcomputer{Mail}{Postfix, Exim, SSMTP}{Backup}{Amanda, BackupManager, Duplicity}
\cvcomputer{Installation et d\'eploiement}{FAI, Kickstart, Reprepro, Cfengine, Puppet\contributor, MCollective\contributor, Augeas\developer}{R\'eseau}{DHCPd, VLANs, OpenVPN, Keepalived}
\cvcomputer{Syst\`emes d'exploitation}{GNU/Linux (Debian\contributor, Ubuntu\developer, RedHat), MacOS X, Windows, *BSD}{Bases de donn\'ees}{MySQL, PostgreSQL, SQLite, BerkeleyDB, CouchDB}
\cvcomputer{Virtualisation}{Xen, VMWare, Docker, Rancher, Kubernetes, OpenShift, Openstack, Amazon Web Services}{S\'ecurit\'e}{SSL, PGP/GnuPG, OpenSSH}
...
\tlcventry{2012}{0}{Développeur \& Formateur Infrastructure}{\href{http://www.camptocamp.com}{Camptocamp}}{}{Chambéry}%
...
\begin{itemize}
  ...
  \item Responsable formations:
    \begin{itemize}
      ...
      \item Écriture et enseignement de cours Augeas (Augeas Fundamentals);
...
\cvhobby{Vie associative}{Pr\'esident de l'association culturelle `la Colombe de Savoie'}
\cvhobby{}{Membre Ubuntu}
