...
gate('P5 hero principle belongs to the orbit', all(html, ['class="hero-orbit-copy"', 'orbit-copy-path', 'IT is about people on both sides of the interface.']) && all(mobileCss, ['.hero-orbit-copy text', 'text-anchor: middle', '.hero-principle']));
